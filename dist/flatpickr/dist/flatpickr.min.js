...
function FlatpickrInstance(element, instanceConfig) {
    ...
    function createDay(className, date, dayNumber, i) {
        ...
        if (dateIsEnabled) {
            ...
            if (isDateSelected(date)) {
                ...
                dayElement.classList.add("mdui-color-theme-accent");
    ...
    function buildMonthNav() {
        ...
        self.monthNav = createElement("div", "flatpickr-month mdui-color-theme");
    ...
    function buildWeekdays() {
        if (!self.weekdayContainer)
            self.weekdayContainer = createElement("div", "flatpickr-weekdays mdui-color-theme");
