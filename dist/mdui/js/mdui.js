...
;(function (window, document, undefined) {
  ...
  mdui.Select = (function () {
    ...
    var readjustMenu = function (_this) {
      ...
      if(_this.options.maxHeight > 0){
          menuHeight = menuHeight > _this.options.maxHeight ? _this.options.maxHeight : menuHeight ;   
      }
  ...
  mdui.Dialog = (function () {
    ...
    var readjust = function () {
      ...
      dialogHeight = dialogHeight > currentInst.options.minHeight ? dialogHeight : currentInst.options.minHeight ; 
